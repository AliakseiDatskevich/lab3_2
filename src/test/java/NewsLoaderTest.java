...
public class NewsLoaderTest {
    ...
    @Before public void setUp() throws Exception {
        ...
        NewsReader newsReaderMock = new NewsReader() {
            ...
            @Override public IncomingNews read() {
                return incomingNews;
            }
        };
    ...
    @Test public void testNewsLoaderLoadNewsCheckPublicNews() {
        PublishableNews publishableNews = newsLoader.loadNews();
        List<String> result = Whitebox.getInternalState(publishableNews, "publicContent");
        assertThat(result.size(), is(1));
        assertThat(result, not(hasItem(subInfo.getContent())));
    }

    @Test public void testNewsLoaderTestLoadNewsCheckSubNews() {
    ...
    @Test public void testLoadNewsCheckNewsReaderFactoryCalledWithCorrectParameter() {
        newsLoader.loadNews();
